...
APP_START_GEMS_CLOSE = get_path(_BASE_APP_START + 'gems_close')
APP_START_LEGENDARY_CLOSE = get_path(_BASE_APP_START + 'legendary_close')
APP_START_LEGENDARY_2_CLOSE = get_path(_BASE_APP_START + 'legendary_2_close')
APP_START_MEGA_PACK_CLOSE = get_path(_BASE_APP_START + 'mega_pack_close')
APP_START_PIGGY_CLOSE = get_path(_BASE_APP_START + 'piggy_close')
